...
void	init_zipf PROTO((zipf_distribution *dist, DSS_HUGE N, double p));
DSS_HUGE	sample_from_zipf PROTO((zipf_distribution *dist, int stream));
...
EXTERN zipf_distribution lineitem_zipf;
EXTERN double lineitem_zipf_p;
